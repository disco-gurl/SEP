...
class LogInSystemTest {
    private Staff.LogInSystemTest.fakeView display;
    ...
    @BeforeEach
    void setUp() {
        display = new Staff.LogInSystemTest.fakeView();
        controller = new UserController(display, new Staff.LogInSystemTest.fakeVerificationService());
