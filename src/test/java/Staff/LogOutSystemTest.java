...
public class LogOutSystemTest {
    private Staff.LogOutSystemTest.fakeView display;
    ...
    @BeforeEach
    void setUp() {
        display = new Staff.LogOutSystemTest.fakeView();
        controller = new UserController(display, new Staff.LogOutSystemTest.fakeVerificationService());
        controller.addUser(new AdminStaff("staff@ed.ac.uk", "group29"));
    }


    @Test
    void Succesfullogin() {
        display.addInput("staff@ed.ac.uk");
