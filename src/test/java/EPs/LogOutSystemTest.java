...
public class LogOutSystemTest {
    private LogOutSystemTest.fakeView display;
    ...
    @BeforeEach
    void setUp() {
        display = new LogOutSystemTest.fakeView();
        controller = new UserController(display, new LogOutSystemTest.fakeVerificationService());
